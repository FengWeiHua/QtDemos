...
{
    connect(&albumModel, &AlbumModel::rowsRemoved, this, &PictureModel::deletePicturesFromAlbum);
}
...
QModelIndex PictureModel::addPicture(const Picture &picture)
{
    ...
    mDb.mPictureDao.addPicutreInAlbum(mAlbumId, *newPicture);
...
QHash<int, QByteArray> PictureModel::roleNames() const
{
    ...
    roles[Role::FilePathRole] = "filepath";
    return roles;
}
...
void PictureModel::deletePicturesFromAlbum()
{
    mDb.mPictureDao.removePicturesFromAlbum(mAlbumId);
    clearAlbum();
}
